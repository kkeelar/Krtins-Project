...
- Implemented CI/CD pipelines with GitHub Actions using test-driven and continuous deployment practices.
...
- Implemented skill-based recommendations and an interactive Leaflet map using Nominatim geocoding.  
- Deployed end-to-end on PythonAnywhere.
...
- Containerized the workflow for scalable and fault-tolerant automation.
